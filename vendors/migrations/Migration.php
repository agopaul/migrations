 ...
 * @access public
 */
	public function createTable($tableName, $columns, $indexes = array(), $options = array()) {
 ...
 * @access public
 */
	public function addColumn($tableName, $columnName, $columnConfig = array()) {
		if ($this->stopOnError && $this->__error) {
			return false;
		}
 ...
 * @access public
 */
	public function changeColumn($tableName, $columnName, $newColumnConfig = array(), $verbose = true) {
		if ($this->stopOnError && $this->__error) {
			return false;
		}
 ...
 * @access protected
 */
	protected function _exec($command, $callback) {
		$this->__error = false;
